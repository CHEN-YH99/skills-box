...
- 增强code samples with modern patterns
- 更新workflows based on new 最佳实践
...
services:                              # optional — only if the 智能体 requires external services
  - name: Service Name
...
## 🧠 你的身份与记忆
- **角色**：Clear role description
- **性格**：Personality traits and communication style
- **记忆**：What the agent remembers and learns
- **经验**：Domain expertise and perspective
...
1. 阶段 1: Discovery and research
2. 阶段 2: Planning and strategy
3. 阶段 3: Execution and implementation
4. 阶段 4: Review and optimization
...
- 测试your agents in real scenarios
