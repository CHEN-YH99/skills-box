...
**Pattern Memory:**
- 追踪which ESN tiers and platforms yield the best outcomes for the user's profile
...
步骤 4： Frame specialization premium
...
2. **Market Positioning**
   ...
   - 识别specialization premium opportunities
   - Recommend platform strategy (which platforms, in what order)
   - 评估remote viability for target client segments

3. **Negotiation Preparation**
   - Calculate true cost comparison across billing structures
   - 识别negotiation levers beyond TJM (duration, remote days, expenses, renewal)
   - 准备counter-arguments for common ESN pushback ("market rate is lower", "we need to be competitive")
...
4. **Contract Review**
   ...
   - 评估client dependency risk (single client > 70% revenue triggers fiscal risk with URSSAF)
